...
public class LessonTimeTest {
	...
	public void testBefore() {
		List<Lesson> result = LessonTime.before(list, new GregorianCalendar(
				2012, 1, 17, 13, 0));
	...
	public void testAfter() {
		List<Lesson> result = LessonTime.after(list, new GregorianCalendar(
				2012, 1, 17, 13, 0));
	...
	public void testBetween() {
		List<Lesson> result = LessonTime.between(list, new GregorianCalendar(
				2012, 1, 15, 14, 0), new GregorianCalendar(2012, 1, 17, 12, 0));
